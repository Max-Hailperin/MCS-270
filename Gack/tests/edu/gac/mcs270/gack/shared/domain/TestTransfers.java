...
public class TestTransfers {
	...
	public void giveOwnedBySelf(){
		...
		assertArrayEquals(new String[]{
				...
				"At Place: donor says -- I give Thing"},
				display.getMessages());	
	}
	...
	public void giveToSelf(){
		...
		newOwner.give(newOwner, thing);
		checkOwnership();
		assertArrayEquals(new String[]{
				"At Place: newOwner says -- I lose Thing",
				"At Place: newOwner says -- I give Thing"},
				display.getMessages());	
	}
	...
	public void giveUnowned(){
		...
		assertArrayEquals(new String[]{"donor can't give Thing"},
				display.getMessages());	
	}
